...
const settings = () => {
  ...
  <SimpleGrid columns={2} spacing={5}>
    ...
    <Tab width={{base:"100%", md:"300px", lg:"300px"}} _focus={{ boxShadow:"none" }} _selected={{ color: "white", bg: "#0C0B0B" }} backgroundColor="#0C0B0B" color="#ffffff" marginRight="20px" marginBottom="12px" justifyContent="left" borderRadius="8px" padding={{base:"10px", md:"15px", lg:"20px 25px"}} fontSize={{base:"13px", md:"18px", lg:"20px"}}><AiOutlineFire height="30px" width="30px" fontSize="25px" style={{ marginRight:"15px", strokeWidth:"50px"}} /> Social Links</Tab>
    <Tab width={{base:"100%", md:"300px", lg:"300px"}} _focus={{ boxShadow:"none" }} _selected={{ color: "white", bg: "#0C0B0B" }} backgroundColor="#0C0B0B" color="#ffffff" marginRight="20px" marginBottom="12px" justifyContent="left" borderRadius="8px" padding={{base:"10px", md:"15px", lg:"20px 25px"}} fontSize={{base:"13px", md:"18px", lg:"20px"}}><FiInbox height="30px" width="30px" fontSize="25px" style={{ marginRight:"15px"}}/> Mailing List Integration</Tab>
    <Tab width={{base:"100%", md:"300px", lg:"300px"}} _focus={{ boxShadow:"none" }} _selected={{ color: "white", bg: "#0C0B0B" }} backgroundColor="#0C0B0B" color="#ffffff" marginRight="20px" marginBottom="12px" justifyContent="left" borderRadius="8px" padding={{base:"10px", md:"15px", lg:"20px 25px"}} fontSize={{base:"13px", md:"18px", lg:"20px"}}><AiOutlineGift height="30px" width="30px" fontSize="25px" style={{ marginRight:"15px", strokeWidth:"22px"}}/> Support Banner</Tab>
    <Tab width={{base:"100%", md:"300px", lg:"300px"}} _focus={{ boxShadow:"none" }} _selected={{ color: "white", bg: "#0C0B0B" }} backgroundColor="#0C0B0B" color="#ffffff" marginRight="20px" marginBottom="12px" justifyContent="left" borderRadius="8px" padding={{base:"10px", md:"15px", lg:"20px 25px"}} fontSize={{base:"13px", md:"18px", lg:"20px"}}><BiCart height="30px" width="30px" fontSize="25px" style={{ marginRight:"15px", strokeWidth:"1px"}}/> Commerce Integrations</Tab>
    <Tab width={{base:"100%", md:"300px", lg:"300px"}} _focus={{ boxShadow:"none" }} _selected={{ color: "white", bg: "#0C0B0B" }} backgroundColor="#0C0B0B" color="#ffffff" marginRight="20px" justifyContent="left" borderRadius="8px" padding={{base:"10px", md:"15px", lg:"20px 25px"}} fontSize={{base:"13px", md:"18px", lg:"20px"}}><FiEyeOff height="30px" width="30px" fontSize="25px" style={{ marginRight:"15px"}}/> Sensitive Material</Tab>
    </SimpleGrid>
  </TabList>
  <TabPanels>
    <TabPanel>
