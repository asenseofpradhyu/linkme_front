...
const LinkPreview = () => {
    return ( 
        <Box className="linkwynk-preview" display={{ base: "none",  md: "none", lg: "flex" }} justifyContent="center" marginTop="40px">
                <Box className="mobile-design-frame" width="auto" overflow="hidden" maxWidth="350px" height="calc(100vh - 240px)" padding="10px"  border="solid #0C0B0B" borderWidth="8px 10px 8px 10px" borderRadius="40px">
